...
values."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(adaptive-wrap company)
...
values."
  ...
  (setq-default
   ...
   ;; (default "M-m")
   dotspacemacs-emacs-leader-key "<f9>"
...
layers configuration. You are free to put any user code."
  ...
  ;; (load "~/.emacs.d/private/auto-capitalization.el" t)

  ;;  Org settings
  (setq org-directory "~/org")
  (setq org-agenda-files
        '("~/org/journal.org" "~/org/oldgtd.org" "~/org/gtd.org" "~/org/class/fall-2015.org" "~/org/vision.org"))
  ...
  (setq org-capture-templates
        '(("c" "Journal" entry (file+datetree "~/org/journal.org")
           "* %?\n%U\n")
          ("e" "Task" entry (file+datetree "~/org/gtd.org")
           "* %?\n%U\n")
  ...
  (global-set-key (kbd "<f1> <f1>") (lambda () (interactive) (org-goto-capture 1 "c")))
